...
const AuraGame = () => {
    ...
    return (
        <>
            <Box sx={{ display: "flex", gap: 1, my: 1, height: "100vh", width: "100%", flexWrap: { lg: "nowrap", md: "nowrap", sm: "wrap", xs: "wrap" } }}>
                ...
                <Box sx={{ width: { lg: "30%", md: "30%", sm: "100%", xs: "100%" }, bgcolor: "#F5F5F5", height: "100%", p: 2, overflowY: 'auto' }}>
                    {/* Credit Dropdown */}
                    <Box
                        sx={{
                            bgcolor: '#214C46',
