...
import { groupInPlaySportsData, newGroupSportsData } from './commonComponents/reusableFunctions';
...
const Header = () => {
    ...
    useEffect(() => {
        setGroupedSportsData(newGroupSportsData(games));
        setInPlayData(groupInPlaySportsData(games));
    }, [games]);
